...
namespace AssignmentNo1.Controllers
{
    public class ExamsController : Controller
    {
        ...
        {
            var databaseContext = _context.Exams.Include(e => e.Student).Include(e => e.Subject);
        ...
        public async Task<IActionResult> Create([Bind("ExamId,Score,StudentId,SubjectId")] Exam exam)
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Students, "Id", "Address", exam.StudentId);
